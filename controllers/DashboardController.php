...
class DashboardController extends BaseController {
    public static function index() {
        ...
        if ($_SESSION['id_rol'] == 1) {
            $stats_query = "SELECT COUNT(CASE WHEN estado = 'Abierto' THEN 1 END) as total_abiertos, COUNT(CASE WHEN estado IN ('En Progreso', 'En Espera') THEN 1 END) as total_pendientes, COUNT(CASE WHEN estado IN ('Resuelto', 'Cerrado') THEN 1 END) as total_resueltos, COUNT(CASE WHEN estado != 'Anulado' THEN 1 END) as total_tickets FROM Tickets";
